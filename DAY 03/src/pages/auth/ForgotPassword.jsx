...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    ...
    const savedPassword = localStorage.getItem('password'); // Replace 'password' with the appropriate key
    if (savedPassword) {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      localStorage.setItem('password', formData.newPassword); // Replace 'password' with the appropriate key
